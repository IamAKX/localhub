...
class OnTheWayOrders extends StatefulWidget {
  @override
  _OnTheWayOrdersState createState() => _OnTheWayOrdersState();
}

class _OnTheWayOrdersState extends State<OnTheWayOrders> {
  // List<OrderModel> orderList = getOrderList();
  List<OrderModel> orderList =
      getOrderList().where((element) => element.status == 'Ontheway').toList();
  @override
